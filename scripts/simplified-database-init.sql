-- Simplified Goal Management Database Initialization Script
-- KISS Methodology: Only essential tables for core goal management functionality
-- Run this ONCE in Supabase SQL Editor to set up the database schema
-- This script removes workflow admin and focus management tables
...
DROP TABLE IF EXISTS public.goal_focus CASCADE;
DROP TABLE IF EXISTS public.user_sessions CASCADE;
DROP TABLE IF EXISTS public.ai_configurations CASCADE;
DROP TABLE IF EXISTS public.goal_ai_analysis CASCADE;
...
-- =============================================================================
-- CREATE CORE TABLES (ESSENTIAL ONLY)
-- =============================================================================
...
-- Create AI configurations table for Ollama connection settings
...
-- =============================================================================
-- CREATE INDEXES FOR PERFORMANCE (ESSENTIAL ONLY)
-- =============================================================================
...
CREATE INDEX idx_ai_configurations_created_by ON public.ai_configurations(created_by);
CREATE INDEX idx_goal_ai_analysis_goal_id ON public.goal_ai_analysis(goal_id);
CREATE INDEX idx_goal_ai_analysis_config ON public.goal_ai_analysis(ai_config_id);
...
-- =============================================================================
-- CREATE ESSENTIAL TRIGGERS ONLY
-- =============================================================================
...
CREATE TRIGGER ai_configurations_updated_at_trigger
    BEFORE UPDATE ON public.ai_configurations
    FOR EACH ROW
    EXECUTE FUNCTION update_updated_at_column();

-- =============================================================================
-- CREATE ESSENTIAL VIEWS ONLY
-- =============================================================================
...
ALTER TABLE public.goal_ai_analysis ENABLE ROW LEVEL SECURITY;
...
-- Other table policies (simplified for essential functionality)
...
-- AI configurations table policies
...
CREATE POLICY "Users can view active AI configurations" ON public.ai_configurations
    FOR SELECT
    USING (is_active = true);

-- Goal AI analysis table policies
CREATE POLICY "Users can view AI analysis for accessible goals" ON public.goal_ai_analysis
    FOR SELECT
    USING (
        goal_id IN (
            SELECT id FROM public.goals 
...
CREATE POLICY "Users can create AI analysis for accessible goals" ON public.goal_ai_analysis
    FOR INSERT
    WITH CHECK (
        goal_id IN (
            SELECT id FROM public.goals 
...
-- KISS Methodology Applied: Removed workflow admin and focus management tables
-- Kept only essential tables for core goal management functionality
