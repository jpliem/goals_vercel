...
import { Target, Upload, Download, CheckCircle, AlertCircle } from "lucide-react"
import { exportGoals, importGoals } from "@/actions/simple-data-management"
    ...
    <Card className={className}>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-gray-500">Download all goals as Excel (.xlsx)</p>
        </div>
